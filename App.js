...
const MappingStackScreen = ({navigation}) => (
  <MappingStack.Navigator screenOptions={{
    headerStyle: {
      backgroundColor: "#009387",
    },
    headerTintColor: "#fff",
    ...
    <MappingStack.Screen name ='?' component={MappingScreen} options={{
      title: 'Mapping',
      headerLeft: () => (
        <Icon.Button name ='ios-menu' size ={25} backgroundColor="#009387"
        onPress={() => navigation.openDrawer()}></Icon.Button>
...
const ResultStackScreen = ({navigation}) => (
  <ResultStack.Navigator screenOptions={{
    ...
    <ResultStack.Screen name ='Result' component={ResultScreen} options={{
      title: 'Result',
      headerLeft: () => (
        <Icon.Button name ='ios-menu' size ={25} backgroundColor="#009387"
        onPress={() => navigation.openDrawer()}></Icon.Button>
